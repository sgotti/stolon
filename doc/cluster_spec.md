...
| externalFallbackSyncStandbys | a list of additional names for possible standbys not included into stolon cluster, but used as replication destinations. Values are comma separated.                                                                                                                                                                                                                                                                                                                           | no                        | []string          | null                                                                                                                                |
